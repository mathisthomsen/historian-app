...
> **Archived 2026-09-18:** executed implementation plan for Epic 2.6 Part A (the public marketing landing page); closed once the page shipped. Kept for forensics only, not as authority — see `docs/archive/README.md`.
