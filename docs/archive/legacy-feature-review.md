...
> **Archived 2026-09-18:** critical review of the legacy feature set that fed the rebuild's roadmap and epic definitions; superseded once the rebuild shipped. Kept for forensics only, not as authority — see `docs/archive/README.md`.
...
**The fundamental tension:** Historians think in narratives, arguments, and interpretations. The current design forces them to think in rows, columns, relations, and confidence decimal scores. Every design decision should be weighed against the question: _does this help a historian build knowledge, or does it make them manage a database?_
