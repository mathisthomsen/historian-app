...
> **Archived 2026-09-18:** test plan for the Source detail page cleanup, closed with the spec it covers. Kept for forensics only, not as authority — see `docs/archive/README.md`.
