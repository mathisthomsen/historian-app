...
> **Archived 2026-09-18:** spec for the Source detail page cleanup workstream (dated 2026-03-24), closed once shipped. Kept for forensics only, not as authority — see `docs/archive/README.md`.
...
<div className="space-y-1">
  <p className="text-muted-foreground text-xs font-medium">{t("field_author")}</p>
