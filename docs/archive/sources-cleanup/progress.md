...
> **Archived 2026-09-18:** progress log for the Source detail page cleanup, closed (see Status below). Kept for forensics only, not as authority — see `docs/archive/README.md`.
