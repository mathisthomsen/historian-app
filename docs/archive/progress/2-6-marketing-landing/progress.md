...
> **Archived 2026-09-18:** progress log for Epic 2.6 Part A (the marketing landing page), closed (see Task 10 below); superseded by GitHub milestones and the project board. Kept for forensics only, not as authority — see `docs/archive/README.md`.
