...
> **Archived 2026-09-18:** progress log for Epic 1.3 (Authentication & Authorization), closed (see Status below); superseded by GitHub milestones and the project board. Kept for forensics only, not as authority — see `docs/archive/README.md`.
