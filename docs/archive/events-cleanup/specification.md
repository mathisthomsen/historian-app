...
> **Archived 2026-09-18:** spec for the Event detail page cleanup workstream (dated 2026-03-24), closed once shipped. Kept for forensics only, not as authority — see `docs/archive/README.md`.
