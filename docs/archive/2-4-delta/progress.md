...
> **Archived 2026-09-18:** progress log for the 2-4-delta gap fixes, closed 2026-03-31 (see Status below). Kept for forensics only, not as authority — see `docs/archive/README.md`.
