...
> **Archived 2026-09-18:** detailed per-epic gap findings backing the 2-4-delta gap analysis, closed with it. Kept for forensics only, not as authority — see `docs/archive/README.md`.
...
```tsx
<dd className="font-mono text-sm text-xs">{person.created_by_id}</dd>
```
