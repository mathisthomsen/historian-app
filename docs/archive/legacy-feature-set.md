...
> **Archived 2026-09-18:** pre-rebuild baseline feature inventory (as of March 2025); superseded by the rebuild. Kept for forensics only, not as authority — see `docs/archive/README.md`.
