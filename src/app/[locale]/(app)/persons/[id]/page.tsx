...
export default async function PersonDetailPage({ params }: PageProps) {
  ...
  const person: PersonDetail = {
    ...
    birth_place_certainty: raw.birth_place_certainty as PersonDetail["birth_place_certainty"],
    ...
    death_place_certainty: raw.death_place_certainty as PersonDetail["death_place_certainty"],
    notes: raw.notes,
