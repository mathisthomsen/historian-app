...
export const mainNavLoggedIn: NavItem[] = [
  ...
  { label: "Person Relations", href: "/person-relations" },
  { label: "Event Relations", href: "/person-event-relations" },
  { label: "Locations", href: "/locations-manage" },
  { label: "Projects", href: "/account/projekte" },
];
